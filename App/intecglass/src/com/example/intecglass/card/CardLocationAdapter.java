 ...
 */
public class CardLocationAdapter extends CardScrollAdapter {
    ...
    public CardLocationAdapter(Context context, List<Card> cards) {
    	mCards = cards;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView != null) {
            ...
            view = mInflater.inflate(R.layout.location, null);
        }
        return view;
    }
