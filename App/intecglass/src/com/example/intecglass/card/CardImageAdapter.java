 ...
 */
public class CardImageAdapter extends CardScrollAdapter {
    ...
    public CardImageAdapter(Context context, List<Card> cards) {
    	mCards = cards;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView != null) {
            ...
            view = mInflater.inflate(R.layout.images, null);
        }
        return view;
    }
