 ...
 */
public class CardInitialAdapter extends CardScrollAdapter {
    ...
    public CardInitialAdapter(Context context, List<Card> cards) {
    	mCards = cards;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView != null) {
            ...
            view = mInflater.inflate(R.layout.initial, null);
        }
        return view;
    }
